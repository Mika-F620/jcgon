...
<div class="faqWrapper">
  <div class="faqWidget" id="faqWidget" aria-expanded="false">
    <button class="faqWidget__header" id="faqToggle" type="button">
      <span class="faqWidget__title">よくあるご質問</span>
    </button>

    <div class="faqWidget__body" id="faqBody" role="dialog" aria-label="よくあるご質問">
      <div class="faqWidget__msg">
        <img
          ...
          alt=""
        >
        <p class="faqWidget__msgText">質問を、下記よりお選びください。</p>
      </div>
      ...
      <div class="faqWidget__content">
        ...
        <div class="faqWidget__footer">
          ...
          <button class="faqWidget__close" id="faqClose" type="button">閉じる</button>
        </div>
      </div>
    </div>
  </div>
